# Taller-IoT 
Introducción a IoT con un simulador Raspbian y una placa NodeMCU Lolin V3
-
...
```scp Taller-IoT.ino pi@IP-DE-LA-RASPBIAN:/home/pi/Arduino/Taller-IoT/Taller-IoT.ino``` y mediante el IDE de Arduino se carga en la tarjeta NodeMCU como en el Ejercicio 2.

* Tras la carga con el navegador del PC anfitrión se accede al Dashboard con el socket IP-DE-LA-RASPBIAN:1880/ui para controlar el encendido y apagado del LED embebido en la placa NodeMCU.
